...
def synthetic_articles():
    adidas = {
        "article_1": "Adidas bought 60% shares of FC Bayern München, making them the largest owner of the club",
        "article_2": "Adidas has started to be active in the advertisement industry",
        "article_3": "Adidas has sold Ashworth",
        "article_4": "Adidas's new CEO is Harm OHLMEYER",
        "article_5": "Adidas new headquarter is London",
        "article_6": "Adidas has started selling Food and Beverages",
        "article_7": "Mathieu Sidokpohou has left the board of Adidas",
        "article_8": "Adidas sold Five Ten to it's Competitor Nike",
        "article_9": "Adidas has introduced a new product line focused on it's founder 'Adi Dassler'",
    }
    ...
    allianz = {
        "article_1": "Allianz has launched a new insurance product aimed at digital nomads, providing coverage for remote workers worldwide.",
        "article_2": "The company reported a record profit in 2024, driven by strong performance in its life and health insurance segments.",
        "article_3": "Allianz is investing heavily in green bonds to support sustainable projects and combat climate change.",
        "article_4": "The CEO of Allianz, Oliver Bäte, has announced a strategic partnership with a leading fintech company to enhance digital services.",
        "article_5": "Allianz has expanded its presence in Asia by acquiring a majority stake in a local insurance firm.",
        "article_6": "The company is actively involved in promoting financial literacy through various community programs.",
        "article_7": "Allianz has received several awards for its innovative insurance solutions and customer service excellence.",
        "article_8": "The firm is focusing on integrating artificial intelligence into its claims processing to improve efficiency.",
        "article_9": "Allianz has committed to achieving net-zero emissions in its investment portfolio by 2050.",
        "article_10": "The company is exploring new technologies in the health insurance sector to enhance patient care."
    }
